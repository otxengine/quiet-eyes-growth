...
const AGENT_LABELS = {
  ...
  autoRespondToReviews:     'AutoRespond — תגובות',
  reviewRequestAutomation:  'ReviewReq — בקשות ביקורת',
  googleRankMonitor:        'RankMon — דירוג גוגל',
  smartLeadNurture:         'Nurture — טיפוח לידים',
  contentCalendarAgent:     'Calendar — תוכן שבועי',
  competitorIntelAgent:     'CompIntel — OSINT',
  detectEvents:             'Events — אירועים',
  detectDeliveryChanges:    'Delivery — פלטפורמות',
