...
export default function OnboardingForm() {
  ...
  const [formData, setFormData] = useState({ name: '', category: '', city: '', full_address: '', website_url: '', facebook_url: '', instagram_url: '', tiktok_url: '' });
  const [isSubmitting, setIsSubmitting] = useState(false);

  const isValid = formData.name && formData.category && formData.city;
