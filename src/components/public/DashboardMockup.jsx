  ...
  return (
    <div className="relative w-full max-w-[560px] mx-auto" style={{ perspective: '1200px' }}>
      <div className="rounded-2xl border border-[#e8e8e8] bg-white overflow-hidden" style={{ transform: 'rotateY(-3deg) rotateX(2deg)', boxShadow: '0 20px 60px rgba(0,0,0,0.06), 0 1px 3px rgba(0,0,0,0.04)' }}>
        {/* Morning briefing */}
        <div className="p-4 border-b border-border/50 bg-secondary/50" style={{ borderRight: '3px solid #10b981' }}>
        ...
        <div className="grid grid-cols-4 gap-2 p-4">
          {[
            ...
            <div key={s.label} className="rounded-lg border border-border/50 p-2.5 bg-white">
        ...
        <div className="px-4 pb-4 space-y-1.5">
          ...
          {[
            ...
            <div key={i} className="flex items-start gap-2 rounded-lg bg-secondary/50 p-2" style={{ borderRight: `2px solid ${s.color}` }}>
