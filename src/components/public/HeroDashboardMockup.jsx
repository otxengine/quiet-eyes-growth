  ...
  return (
    <div className="relative" style={{ perspective: '1000px' }}>
      ...
      >
        <div className="flex">
          {/* Mini sidebar */}
          <div className="w-10 bg-secondary/50 border-l border-border/50 hidden sm:flex flex-col items-center py-3 gap-3">
          ...
          <div className="flex-1 p-4">
            {/* Morning briefing */}
            <div className="bg-secondary/50 rounded-lg p-3 mb-3" style={{ borderRight: '2px solid #10b981' }}>
            ...
            <div className="grid grid-cols-4 gap-2 mb-3">
              {[
                ...
                <div key={i} className="bg-white border border-border/50 rounded-lg p-2">
            ...
            <div className="space-y-1.5">
              {['תובנה: ביקוש עולה ל...', 'מתחרה חדש באזור...', 'הזדמנות: נישה פנוי...'].map((text, i) => (
                <div key={i} className="flex items-center gap-1.5 bg-white border border-border/50 rounded-md px-2 py-1.5">
