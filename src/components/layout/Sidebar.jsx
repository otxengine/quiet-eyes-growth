        ...
        {isAdmin && (
          <div className="px-2 mb-1">
            <Link
              ...
              style={{
                background: location.pathname === '/admin-dashboard' ? 'hsl(var(--sidebar-accent-active))' : 'transparent',
                color: location.pathname === '/admin-dashboard' ? 'hsl(var(--sidebar-accent-foreground))' : 'hsl(var(--sidebar-foreground-muted))',
              }}
              onMouseEnter={e => { if (location.pathname !== '/admin-dashboard') { e.currentTarget.style.background = 'hsl(var(--sidebar-accent))'; e.currentTarget.style.color = 'hsl(var(--sidebar-accent-foreground))'; } }}
              onMouseLeave={e => { if (location.pathname !== '/admin-dashboard') { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = 'hsl(var(--sidebar-foreground-muted))'; } }}
            >
