    ...
    <div className="mt-3 rounded-lg border border-[#e8e8e8] bg-secondary/50 overflow-hidden">
      ...
      <div className="flex items-center justify-between px-3 py-2 cursor-pointer border-b border-border/60"
        ...
        <div className="flex items-center gap-1.5">
          <Target className="w-3.5 h-3.5 text-foreground-secondary" />
      ...
      <div className="px-3 pb-3 pt-2">
        ...
        {loading && (
          <div className="animate-pulse space-y-2 py-1">
            ...
            <div className="h-8 w-full bg-secondary/70 rounded-lg mt-2" />
        ...
        {!loading && strategy && (
          <div className="space-y-3">
            ...
            {/* Timeline badge */}
            {strategy.timeline && (
              <p className="text-[10px] text-foreground-muted">⏱ אופק זמן: {strategy.timeline}</p>
            )}
                ...
                <div className="space-y-1.5">
                  {strategy.tactics.map((tactic, i) => (
                    <button key={i}
                      ...
                      <CheckCheck className="w-3 h-3 text-foreground-muted/70 group-hover:text-violet-500 flex-shrink-0 transition-colors" />
                    </button>
                  ))}
                </div>
              </div>
