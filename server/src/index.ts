...
app.listen(PORT, async () => {
  ...
  await sql(`ALTER TABLE competitor_ad_history ADD COLUMN IF NOT EXISTS video_url TEXT`);
  ...
  await sql(`ALTER TABLE business_profiles ADD COLUMN IF NOT EXISTS about_draft TEXT`);
  ...
  await sql(`ALTER TABLE competitors ADD COLUMN IF NOT EXISTS outlier_insight TEXT`);
  await sql(`ALTER TABLE competitors ADD COLUMN IF NOT EXISTS outlier_insight_at TEXT`);
  ...
  await sql(`ALTER TABLE automation_logs ADD COLUMN IF NOT EXISTS trace_id TEXT`);
  await sql(`ALTER TABLE automation_logs ADD COLUMN IF NOT EXISTS high_urgency_count FLOAT DEFAULT 0`);
